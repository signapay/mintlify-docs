...
The PayHub API exposes resources covering the full merchant lifecycle. All endpoints require a valid API key passed in the `Authorization` header. See the [Authentication overview](/tutorials/authentication/overview) for details on obtaining credentials.
