...
<CardGroup cols={4}>
  ...
  <Card title="Activities" icon="clock-rotate-left" href="/api-reference/tickets/list-ticket-activities">
    Append comments and work log entries to a ticket's activity feed.
  </Card>
  <Card title="Watchers" icon="eye" href="/api-reference/tickets/list-ticket-watchers">
    Subscribe and unsubscribe users from ticket notifications.
  </Card>
  <Card title="Clients" icon="building" href="/api-reference/tickets/list-ticket-clients">
    Link and unlink client records from a ticket.
  </Card>
  <Card title="Documents" icon="file-lines" href="/api-reference/tickets/list-ticket-documents">
    Attach, retrieve, update, and remove documents on a ticket.
  </Card>
  <Card title="External Users" icon="user-group" href="/api-reference/tickets/list-ticket-external-users">
    Add non-platform users to a ticket for visibility or coordination.
  </Card>
  <Card title="SAM Action Logs" icon="list" href="/api-reference/tickets/list-sam-action-logs">
