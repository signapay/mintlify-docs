...
<CardGroup cols={2}>
  <Card title="Activities" icon="comment-dots" href="/api-reference/tickets/activities">
  ...
  <Card title="SAM Action Logs" icon="clock-rotate-left" href="/api-reference/tickets/sam-action-logs">
