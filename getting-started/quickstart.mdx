...
- A long-lived **API key** issued for your client — see [Authentication](/tutorials/authentication/overview) for details
...
API keys are the only supported authentication method for API integrations. Keys are managed through the [Client API Key](/api-reference/clients/get-client-api-key) endpoints.
...
- **Authentication deep dive** — Learn about API key management and authentication in the [Authentication overview](/tutorials/authentication/overview).
