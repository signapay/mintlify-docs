...
<CardGroup cols={2}>
  <Card title="Leads Overview" icon="file-text" href="/api-reference/leads/overview">
    Full reference for the lead lifecycle, status pipeline, and all available sub-resources.
  </Card>
  <Card title="Financial Reporting" icon="line-chart" href="/api-reference/financial-reporting/overview">
